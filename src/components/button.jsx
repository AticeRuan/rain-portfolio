...
const Button = () => {
  return (
    <div className="border w-full h-40 flex items-center justify-center">
      <a
        href="#_"
        className="relative px-5 py-3 overflow-hidden font-medium text-white bg-tranparent border-none hover:border border-gray-100 rounded-lg shadow-inner group"
      >
